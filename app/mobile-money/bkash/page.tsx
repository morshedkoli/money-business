        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="border-b border-gray-200 p-4 sm:p-6">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-gray-900">bKash Transfer</h1>
                <p className="text-sm sm:text-base text-gray-600">Send money via bKash</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded-lg p-4">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="font-medium text-pink-900">bKash</h3>
                    <p className="text-sm text-pink-700">Mobile financial service</p>
                  </div>
                </div>
              </div>
