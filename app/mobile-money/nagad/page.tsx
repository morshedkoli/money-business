        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="border-b border-gray-200 p-4 sm:p-6">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Nagad Transfer</h1>
                <p className="text-sm sm:text-base text-gray-600">Send money via Nagad</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
              ...
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="font-medium text-orange-900">Nagad</h3>
                    <p className="text-sm text-orange-700">Digital financial service</p>
                  </div>
                </div>
              </div>
